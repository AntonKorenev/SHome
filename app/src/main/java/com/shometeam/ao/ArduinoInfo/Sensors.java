...
public class Sensors  implements Serializable {
     ...
     */
    public synchronized void addMeasurements (Float temperature, Float humidity, Float illumination, Float pressure) {
     ...
     */
    public synchronized void addRoomByIndex (int index, Room room) {
        rooms[index] = room;
    }
     ...
     */
    public synchronized Room getRoomByIndex (int index) throws ArrayIndexOutOfBoundsException {
        return rooms[index];
    }
     ...
     */
    public synchronized Sensors getAverage (List<Sensors> list) {
